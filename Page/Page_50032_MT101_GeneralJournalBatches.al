page 50032 "MT101 General Journal Batches"
{
    Caption = 'Signatory Batches';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("MT101"; "MT101") { ApplicationArea = All; }
        ...
        area(processing)
        {
            action(EditJournal)
            {
                ...
                begin
                    ...
                    if grecGenJnlTemplate.Get('PAYMENTS') then;
                    TemplateSelectionFromBatch(Rec);
                    OpenJournalPageFromBatch(Rec, grecGenJnlTemplate);
                end;
            }
            group("P&osting")
            {
