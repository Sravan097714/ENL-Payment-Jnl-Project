page 50031 "Vendor Ledger Entries 2"
{
    Caption = 'Invoices';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(poname; poname) { ApplicationArea = all; Caption = 'Purchase Order Approved By'; Editable = false; }
                field(piname; piname) { ApplicationArea = all; Caption = 'Purchase Invoice Approved By'; Editable = false; }
        ...
        area(factboxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = All;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = filter(122 | 124),
    ...
    begin
        ...
        if userrec.FindFirst then
            poname := userrec."Full Name";


        userrec.Reset();
        userrec.SetRange("User Name", "PI Approved By");
        if userrec.FindFirst then
            piname := userrec."Full Name";
