page 50033 "ApplyVendor Entries"
{
    Caption = 'Invoices';
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field(POApproverName; POApproverName) { ApplicationArea = all; Caption = 'Purchase Order Approved By'; }
                field(PIApproverName; PIApproverName) { ApplicationArea = all; Caption = 'Purchase Invoice Approved By'; }
            }
    ...
    begin
        ...
        if userrec.FindFirst then
            POApproverName := userrec."Full Name";

        userrec.Reset();
        userrec.SetRange("User Name", "PI Approved By");
        if userrec.FindFirst then
            PIApproverName := userrec."Full Name";
    end;
