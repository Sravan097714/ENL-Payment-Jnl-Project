...
page 50039 "Approval"
{
    ...
    layout
    {
        area(rolecenter)
        {
            part(Control76; "Headline RC Project Manager")
            {
            ...
            {
                ApplicationArea = Suite;
                Visible = false;//LS05072021
            }
            part(ApprovalActivitiesOrder; "Approvals Activities Order")
            {
                ApplicationArea = Suite;
            }
            part(ApprovalActivitiesInvoice; "Approvals Activities Invoice")
            {
                ApplicationArea = Suite;
            }
            part(ApprovalActivitiesPayment; "Approvals Activities Payment")
            {
                ApplicationArea = Suite;
            }
            part(VendorApproval; "Vendor Approval Cue")
            {
                ApplicationArea = Suite;
            }
            ...
            part("Director Notification Entries"; "Director Notification Entries")
            {
                ApplicationArea = All;
            }
