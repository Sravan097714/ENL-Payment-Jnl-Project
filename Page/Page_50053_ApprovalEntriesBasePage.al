page 50053 "ApprovalEntriesBasePageAppOp"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(lastusername; lastusername) { ApplicationArea = all; Editable = false; Visible = false; }
    ...
    begin
        ...
        vendorledgerentryrec.SetRange("Applies-to ID", "Document No.");
        if vendorledgerentryrec.FindFirst
        then begin
            poapprovername := vendorledgerentryrec.POApproverName;
            piapprovername := vendorledgerentryrec.PIApproverName;
        end;
