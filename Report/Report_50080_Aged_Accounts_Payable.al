//LS
report 50080 "ENL - Aged Accounts Payable"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\AgedAccountsPayable.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'ENL - Aged Accounts Payable';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    column(postdesc; VendorLedgEntryEndingDate.Description) { }
