//LS
report 50081 "ENL - Aged Accounts Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\AgedAccountsReceivable.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'ENL - Aged Accounts Receivable';
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(postdesc; CustLedgEntryEndingDate.Description) { }
    ...
    var
        ...
        PostingDesc: Label 'Posting Desc';
