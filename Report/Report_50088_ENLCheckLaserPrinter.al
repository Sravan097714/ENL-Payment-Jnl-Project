report 50088 "ENL-Check Laser printer"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\ENLCheckLaserPrinter.rdl';
    UsageCategory = ReportsAndAnalysis;
    Caption = 'ENL - Check Laser printer';
                        ...
                        IF NOT TestPrint THEN BEGIN
                            WITH GenJnlLine DO BEGIN
                                ...
                                IF FoundLast THEN BEGIN
                                    ...
                                    ELSE
                                        CheckAmountText := FORMAT(CheckLedgEntry.Amount, 0, 0);
                                    gtextamounttoprint := FORMAT(CheckLedgEntry.Amount, 0, '<Precision,2><sign><Integer Thousand><Decimals,3>');
                                    evaluate(gdecamounttoprint, gtextamounttoprint);
                                    FormatNoText(DescriptionLine, gdecamounttoprint, BankAcc2."Currency Code");
                                    VoidText := '';
                                END ELSE BEGIN
    ...
    var
        ...
        Remittance: Record 50030;
        LineNo: Integer;
        NoOfLines: Integer;
        DisplaySection: Boolean;
        ChequeTriggers: Record 50031;
        LineNoVar: Integer;
        ChequeTriggers1: Record 50031;
        Vendor: Record 23;
