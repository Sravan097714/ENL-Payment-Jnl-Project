report 50090 "ENL-VAT Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\ENLVATReport.rdl';
    Caption = 'ENL Consolidated VAT Report';
                ...
                if "VAT Entry"."Bill-to/Pay-to No." <> '' then begin
                    ...
                    case Type OF
                        Type::Sale:
                            begin
                                if "Document Type" = "Document Type"::Invoice then begin
                                    if SalesInvHeaderRec.Get("VAT Entry"."Document No.") then;
                                    SalesDesc := SalesInvHeaderRec."Posting Description"
                                end else
                                    if "Document Type" = "Document Type"::"Credit Memo" then begin
                                        if SalesCrdHdr.Get("VAT Entry"."Document No.") then;
                        ...
                        Type::Purchase:
                            begin
                                if "Document Type" = "Document Type"::Invoice then begin
                                    if PurInvHdr.Get("VAT Entry"."Document No.") then;
                                    SalesDesc := PurInvHdr."Posting Description"
                                end else
                                    if "Document Type" = "Document Type"::"Credit Memo" then begin
                                        if PurCrdHdr.Get("VAT Entry"."Document No.") then;
